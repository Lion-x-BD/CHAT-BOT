...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ AHMED AVRO☜\nFacebook: https://www.facebook.com/profile.php?id=61582824098917\nWhatsApp: +8801836299297",
    "admin": "He is AHMED AVRO  ছেলে ভাল শুদু নাগিন দের বিষ খায়",
    ...
    "kiss": "তুমি পঁচা তোমাকে কিস দিবো না 🤭",
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস AHMED ABRO রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস  এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    "by": "কিরে তুই কই যাস কোন মেয়ের সাথে চিপায় যাবি..!🌚🌶️",
    "ami AVRO": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌MEAW ",
